...
/* move Multisynq QR code to top-right (it's normally in the bottom-left) */
#croquet_dock {
	top: 10px;
	right: 10px;
	left: auto;
	...
	<script type="importmap" >
	{
		"imports": {
			...
			"@multisynq/client": "https://cdn.jsdelivr.net/npm/@multisynq/client@1.0.1/bundled/multisynq-client.esm.js"
		}
	}
		</script>
		</head>
